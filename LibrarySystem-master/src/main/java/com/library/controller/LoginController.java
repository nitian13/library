...
public class LoginController {
    ...
    //这段代码是一个基于Spring框架的Java Web应用程序中的一个控制器方法。
    // 该方法使用@RequestMapping注解来映射URL路径"/admin_main.html"，当用户访问该路径时，将会执行该方法。
    //方法的返回类型是ModelAndView，表示返回一个包含视图名称和模型数据的对象。在这个方法中，它返回一个名为"admin_main"的视图。
